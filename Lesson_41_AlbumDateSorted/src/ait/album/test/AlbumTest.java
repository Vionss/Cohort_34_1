...
class AlbumTest {
    ...
    void addPhoto() {
        ...
        Photo photo = new Photo(4,2,"title12","url42", now.minusDays(3));
        assertTrue(album.addPhoto(photo));
        assertEquals(7,album.size());
        photo = new Photo(4,2,"title12","url42", now.minusDays(3));
        assertFalse(album.addPhoto(photo));
    }

    @org.junit.jupiter.api.Test
    void removePhoto() {
        assertFalse(album.removePhoto(44,12));
    ...
    void getPhotosBetweenDate() {
        ...
        Photo[] actual = album.getPhotosBetweenDate(ld.minusDays(5), ld.minusDays(2));
